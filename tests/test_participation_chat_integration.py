...
class ParticipationChatIntegrationTest(unittest.TestCase):
    ...
    def test_instant_join_approves_and_adds_chat_member(self):
        ...
        self.assertEqual(
            response.get_json()["participation_status"],
            "APPROVED"
        )
    ...
    def test_cancel_updates_status_and_removes_chat_member(self):
        def assert_committed_before_socket_removal(
            ...
            self.assertTrue(
                self.last_connection.committed
            )
        ...
        remove_socket_member.assert_called_once_with(
            2,
            20
        )
    ...
    def test_chat_membership_failure_rolls_back_participation(self):
        ...
        self.assertTrue(
            self.last_connection.rolled_back
        )
